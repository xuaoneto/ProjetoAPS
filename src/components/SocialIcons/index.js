...
export function SocialIcons({ size = "30px", spacing = null }) {
  return (
    <>
      <Link borderRadius="50%" href="#" _hover={{ bg: "#1877F2" }} mr={spacing}>
        <Image alt="facebook icon" w={size} src={facebook.src} />
      </Link>
      <Link borderRadius="50%" href="#" _hover={{ bg: "#1DA1F2" }} mr={spacing}>
        <Image alt="twitter icon" w={size} src={twitter.src} />
      </Link>
      <Link borderRadius="50%" href="#" _hover={{ bg: "#0A66C2" }} mr={spacing}>
        <Image alt="linkedin icon" w={size} src={linkedin.src} />
      </Link>
      <Link borderRadius="50%" href="#" _hover={{ bg: "#E4405F" }} mr={spacing}>
        <Image alt="instagram icon" w={size} src={instagram.src} />
      </Link>
      <Link borderRadius="50%" href="#" _hover={{ bg: "#CD201F" }}>
